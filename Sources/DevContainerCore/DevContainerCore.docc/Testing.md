...
D06's Docker reference passes forwarding metadata, guest/host HTTP, specific port-collision rejection and cleanup at `b5b60e0`, invocation `524dce17-469a-4819-9258-a210a414d7cb`. Raw setup/operation/cleanup are 18.104937083/1.007004959/2.990339625 seconds, not quiet paired benchmarks. The candidate frontend now sends explicit IPv4/fixed TCP publications and inspection reports recorded host bindings; component tests include real executable/private-socket requests. Native live qualification remains pending. Dynamic/range/IPv6/UDP publish forms are explicitly rejected by this frontend; there is no external Docker fallback.
