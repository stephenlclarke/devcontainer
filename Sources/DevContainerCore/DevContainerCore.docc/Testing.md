...
D07 reuse/rebuild/cleanup passes its six original assertions on the pinned Docker reference (`be380dd2-e11c-44d3-8297-56b03212fb23`). Stock's named-volume correction now permits creation and reuse, but invocation `87b56dd6-7499-48e3-84eb-653f135714ac` fails at rebuild's missing `rm -f` frontend command. Exact-ID removal is now implemented; 75 focused frontend tests pass at `42086676-4ae6-4e0e-9bc7-913507c7ed41`, including real executable/private-socket success and failure. The failed environment was recovered with services restored, without rewriting its result. Corrected native live proof remains required; no release or quiet paired benchmark is inferred from component or functional runs.
