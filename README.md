...
C03's original environment-file, named-volume, alias and peer-connectivity fixture now has a [Bazel adapter with exact resource cleanup](docs/bazel-test-harness.md#c03-compose-resources). It reuses downloaded reference tools and existing prepared candidates; live qualification and quiet release comparisons remain outstanding.
