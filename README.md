...
D07 reuse/rebuild/cleanup is the current harness contract. Its replacement verifies immutable container identity, hook idempotence, persistent volume counters and ownership-bound removal; live reference/native proof remains pending. See the [D07 contract](docs/bazel-test-harness.md#d07-reuse-and-cleanup). Component success does not qualify a release.
