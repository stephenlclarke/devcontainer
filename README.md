...
C01 Compose-service configuration is now the active Bazel replacement contract. Its Docker reference passes the original service, hook and workspace assertions with private project/network ownership and verified cleanup. Docker-free native-provider proof remains outstanding. See the [C01 contract](docs/bazel-test-harness.md#c01-compose-service).
