...
from compose_foreground_probe import (ComposeForegroundFixture, ComposeTerminalInputFixture,
                                      FIXTURES as COMPOSE_FOREGROUND_FIXTURES,
                                      QUIET_FIXTURE, REDIRECTED_FIXTURE, TTY_INPUT_FIXTURE)
...
class ReleasedGuest:
    ...
    def operation(self):
        ...
        if self.fixture in COMPOSE_FOREGROUND_FIXTURES:
            ...
            fixture_type = ComposeTerminalInputFixture if self.fixture == TTY_INPUT_FIXTURE else ComposeForegroundFixture
