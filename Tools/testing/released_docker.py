...
def admit_docker(oracle_lock: dict, cli_lock: dict, pins: dict, images: dict, scratch: Path, retained: Path,
    ...
    workload = "ubuntu-workload" if fixture == FEATURES_FIXTURE else "alpine-workload"
    ...
    if fixture in {DEVCONTAINER_FIXTURE, BUILD_FIXTURE, USERS_FIXTURE, LIFECYCLE_FIXTURE, FEATURES_FIXTURE}:
        ...
        readers = {DEVCONTAINER_FIXTURE: fixture_inputs, BUILD_FIXTURE: build_fixture_inputs,
                   ...
                   FEATURES_FIXTURE: features_fixture_inputs}
...
class DockerCase:
    ...
    def setup(self):
        ...
        self.vm.start()
        if self.identity["fixture"] in {DEVCONTAINER_FIXTURE, BUILD_FIXTURE, USERS_FIXTURE, LIFECYCLE_FIXTURE, FEATURES_FIXTURE}:
            adapter = {DEVCONTAINER_FIXTURE: DevcontainerReference, BUILD_FIXTURE: DevcontainerBuildReference,
                       ...
                       FEATURES_FIXTURE: DevcontainerFeaturesReference}[self.identity["fixture"]]
