...
main() {
    ...
    case "$command" in
        ...
        configure|test-tools|recover-runtime|cleanup|restore-candidate|coverage-report|build-timings|acquire-releases|prepare-releases|prepare-guest-images|build|test|coverage|query|cquery|aquery|info|shutdown) shift ;;
